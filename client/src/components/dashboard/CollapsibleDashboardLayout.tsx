    ...
    <SidebarProvider defaultOpen={true}>
      <div className="flex min-h-screen w-full">
        ...
        <SidebarInset className="flex-1">
          ...
          <header className="flex h-16 shrink-0 items-center gap-2 border-b border-border bg-background px-4 ml-0 transition-all duration-300 ease-in-out lg:ml-0">
            <SidebarTrigger className="mr-2 transition-all duration-200 ease-in-out hover:scale-110 active:scale-95 lg:mr-2" />
