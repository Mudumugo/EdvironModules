...
const parentChildSignupSchema = z.object({
...
const schoolDemoSchema = z.object({
...
type AdultSignupForm = z.infer<typeof adultSignupSchema>;
type ParentChildSignupForm = z.infer<typeof parentChildSignupSchema>;
type SchoolDemoForm = z.infer<typeof schoolDemoSchema>;

export default function SignUp() {
  const [currentStep, setCurrentStep] = useState<"age-check" | "signup" | "verification" | "complete">("age-check");
  const [userAge, setUserAge] = useState<number | null>(null);
  const [signupType, setSignupType] = useState<"student" | "parent" | "adult" | "school" | null>(null);
