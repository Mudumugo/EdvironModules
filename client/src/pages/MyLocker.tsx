  ...
  return (
    ...
    <TabsContent value="resources" className="mt-6">
      <div className="space-y-6">
                ...
                <CardHeader className="pb-3">
                  <div className="flex items-start justify-between">
                    <div className="flex items-start space-x-3">
                      {item.itemType === 'resource' && <FileText className="h-5 w-5 text-blue-500 mt-1" />}
                      {item.itemType === 'bookmark' && <BookmarkPlus className="h-5 w-5 text-green-500 mt-1" />}
                      {item.itemType === 'notebook' && <BookOpen className="h-5 w-5 text-purple-500 mt-1" />}
        ...
        {!isLoadingItems && lockerItems.length === 0 && (
