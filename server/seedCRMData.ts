    ...
    const sampleLeads = [
      {
        ...
        location: { county: "Nairobi", constituency: "Westlands", ward: "Parklands" },
        source: "website",
        status: "new",
        priority: "high",
      ...
      },
      {
        ...
        location: { county: "Kiambu", constituency: "Thika Town", ward: "Township" },
        source: "website",
        status: "contacted",
        priority: "medium",
      ...
      },
      {
        ...
        location: { county: "Nakuru", constituency: "Nakuru Town East", ward: "Biashara" },
        source: "referral",
        status: "qualified",
        priority: "high",
      ...
      },
      {
        ...
        location: { county: "Kisumu", constituency: "Kisumu Central", ward: "Market Milimani" },
        source: "social",
        status: "new",
        priority: "medium",
      ...
      },
      {
        ...
        location: { county: "Meru", constituency: "Igembe South", ward: "Maua" },
        source: "website",
        status: "lost",
        priority: "low",
