    ...
    const sampleLeads = [
      {
        ...
        interests: JSON.stringify(["Mathematics", "Science"]),
        location: JSON.stringify({ county: "Nairobi", constituency: "Westlands", ward: "Parklands" }),
        source: "website",
        status: "new",
        priority: "high",
      ...
      },
      {
        ...
        age: 35,
        account_type: "family",
        interests: JSON.stringify(["Primary Education", "Secondary Education"]),
        location: JSON.stringify({ county: "Kiambu", constituency: "Thika Town", ward: "Township" }),
        source: "website",
        status: "contacted",
        priority: "medium",
      ...
      },
      {
        ...
        age: 45,
        account_type: "school",
        interests: JSON.stringify(["School Management", "Digital Library"]),
        location: JSON.stringify({ county: "Nakuru", constituency: "Nakuru Town East", ward: "Biashara" }),
        source: "referral",
        status: "qualified",
        priority: "high",
      ...
      },
      {
        ...
        age: 18,
        account_type: "individual",
        interests: JSON.stringify(["University Prep", "Engineering"]),
        location: JSON.stringify({ county: "Kisumu", constituency: "Kisumu Central", ward: "Market Milimani" }),
        source: "social",
        status: "new",
        priority: "medium",
      ...
      },
      {
        ...
        age: 28,
        account_type: "family",
        interests: JSON.stringify(["Early Learning", "Parental Guidance"]),
        location: JSON.stringify({ county: "Meru", constituency: "Igembe South", ward: "Maua" }),
        source: "website",
        status: "lost",
        priority: "low",
