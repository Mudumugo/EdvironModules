...
let notifications: Notification[] = [
  ...
  // Teacher notifications
  {
    ...
    type: "info",
    category: "assignment",
    title: "18 New Assignment Submissions",
    message: "Students have submitted their Math Quiz assignments. Click to review and grade.",
  ...
  },
  {
    ...
    message: "3 parents have booked conference slots for next week. Check your calendar for details.",
  ...
  {
    id: "notif_teacher_003",
    userId: "demo_teacher", 
    type: "warning",
    category: "academic",
    title: "Grading Deadline Reminder",
    message: "Science lab reports are due for grading by Friday. 8 assignments still need review.",
    ...
    try {
      ...
      if (user?.role === 'teacher' || user?.role === 'demo_teacher') {
        userNotifications = notifications.filter(n => 
          n.userId === 'demo_teacher' || n.userId === user.id
        );
      } else {
        userNotifications = notifications.filter(n => 
          n.userId === user?.id || n.userId === 'demo_student_elementary'
        );
      }
